...
public class Productor extends javax.swing.JFrame implements Runnable{
     ...
     */
    boolean bandTerminado=false;
    int ultimaPosicion=0;
    public Productor() {
        initComponents();
        this.setBounds(150,200,291,180);
    }
    ...
    public String produceCaracter()
    {
        Random rd=new Random();
        int produccion=(int)(rd.nextDouble()*100+1);
        return Integer.toString(produccion);
    }
    public void run()
    {
        while(bandTerminado==false)
        {
